...
import AuthButton from "../../AuthButton"; // plasmic-import: 0JDbAiNprF2l/component
...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: XBaUeZjglG3n/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: viOQS4hD0QMX/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: Cwkx82Gc8snt/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__u4IoC)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__chIfV)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___5RIji)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___1DJdr)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___7N4QH)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
