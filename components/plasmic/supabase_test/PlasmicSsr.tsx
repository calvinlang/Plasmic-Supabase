...
import sty from "./PlasmicSsr.module.css"; // plasmic-import: UeCY3koaqPeL/css
...
function PlasmicSsr__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    todos: usePlasmicDataOp(() => {
      return {
        sourceId: "vfjb9QpAXooeuUKxwRfGkH",
        opId: "e3f67800-6967-4bf0-957f-a9646b190a6e",
        userArgs: {},
        cacheKey: `plasmic.$.e3f67800-6967-4bf0-957f-a9646b190a6e.$.`,
        invalidatedKeys: null,
        roleId: "18458231-1b0a-4222-87dc-78c241c78a8c"
      };
    })
  };
          ...
          >
            <ph.DataCtxReader>
              {$ctx => (
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__bw5Fg)}
                  >
                    <h3
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox___9Zfbq)}
                  >
                    {(() => {
                      const child$Props = {
                              ...
                              $steps["tutorialdbCreate"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "vfjb9QpAXooeuUKxwRfGkH",
                                        opId: "da1d29e5-fcd3-4115-83f7-44a4fea1fe2c",
                                        userArgs: {
                                          variables: [
                                        ...
                                        roleId:
                                          "18458231-1b0a-4222-87dc-78c241c78a8c"
                                      }
                                    };
                                    return (async ({
                                      dataOp,
...
function withPlasmicPageGuard<P extends object>(
  ...
  const PageGuard: React.FC<P> = props => (
    <p.PlasmicPageGuard
      minRole={"18458231-1b0a-4222-87dc-78c241c78a8c"}
