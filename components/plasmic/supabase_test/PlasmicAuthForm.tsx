...
import sty from "./PlasmicAuthForm.module.css"; // plasmic-import: p7rYmpV8dbKa/css
...
function PlasmicAuthForm__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__wfUgR, {
          [sty.freeBoxmode_checkEmail__wfUgR3Ot2E]: hasVariant(
            $state,
            "mode",
            "checkEmail"
          )
      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__lBsy)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__jXlmG)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text___3Ez9T,
                    {
                      [sty.textmode_signUp___3Ez9TzJzNk]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__tbEqP, {
            [sty.freeBoxmode_checkEmail__tbEqP3Ot2E]: hasVariant(
              $state,
              "mode",
              "checkEmail"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text___27IV0,
              {
                [sty.textmode_signUp___27IV0ZJzNk]: hasVariant(
                  $state,
                  "mode",
                  "signUp"
                )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__hkT34, {
          [sty.freeBoxmode_checkEmail__hkT343Ot2E]: hasVariant(
            $state,
            "mode",
            "checkEmail"
          )
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__wZjQe,
            {
              [sty.textmode_checkEmail__wZjQe3Ot2E]: hasVariant(
                $state,
                "mode",
                "checkEmail"
              )
